      ...
      <div className="w-[100vw] relative">
        {video && (
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  z-10">
            <button
              className="absolute top-[-40px] right-[-40px] w-[40px] h-[40px] bold bg-white hover:bg-slate-100 text-red-500 text-2xl flex justify-center items-center cursor-pointer rounded-full"
              onClick={() => setVideo("")}
            >
              X
            </button>
