...
const cardColors = [
  ...
  { bg: "from-yellow-500 to-orange-500", light: "bg-yellow-50", text: "text-yellow-600" },
  { bg: "from-blue-600 to-indigo-600", light: "bg-indigo-50", text: "text-indigo-600" },
  { bg: "from-cyan-500 to-teal-500", light: "bg-cyan-50", text: "text-cyan-600" },
  { bg: "from-gray-800 to-gray-600", light: "bg-gray-50", text: "text-gray-700" },
  ...
  { bg: "from-gray-700 to-gray-900", light: "bg-gray-100", text: "text-gray-700" },
];
...
function CourseSection() {
  ...
  return (
    <section id="courses" className="w-full py-16 px-4 bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 sm:gap-6">
          {courseData.map((course, index) => {
            ...
            return (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${color.bg} opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl`}></div>

                <div className="relative z-10 flex flex-col items-center p-6 sm:p-8">
                  <div className={`${color.light} group-hover:bg-white/20 w-20 h-20 sm:w-24 sm:h-24 rounded-2xl flex items-center justify-center mb-4 transition-colors duration-300`}>
                    <Image
                      src={course.icon}
                      width={56}
                      height={56}
                  ...
                  <h3 className={`text-lg sm:text-xl font-semibold ${color.text} group-hover:text-white transition-colors duration-300`}>
                    {course.name}
                  </h3>
